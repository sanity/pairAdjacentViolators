...
class PAVSpec : FreeSpec() {
    init {
        ...
        "Default PAV should not change an already increasing set of points" {
        ...
        "Default PAV should merge a single pair of non-increasing points" {
        ...
        "Default PAV should merge multiple non-increasing points" {
        ...
        "Inverse PAV should not merge decreasing points" {
